  ...
  const fetchData = async () => {
    try {
      ...
      if (vehicleData) {
        ...
        if (vehicleData.branch) {
          setBranch(vehicleData.branch)
        }
      }
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-dark">차량 상세</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {branch && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <Link
                  href={`/branch/${branch.subdomain || branch.name}`}
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <p className="font-bold text-white">차놀자</p>
              <p className="text-sm">전국 렌터카 프랜차이즈</p>
            </div>
